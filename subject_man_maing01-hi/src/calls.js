...
let Calls = {
  ...
  getLog() {
    let commandUri = Calls.getCommandUri("sys/logRecord/list");
    return Calls.call("get", commandUri, {});
  },
  ...
  async getPrograms(dtoInData) {
    let commandUri = Calls.getCommandUri("program/get/all");
    return Calls.call("get", commandUri, dtoInData);
  },
  async getProgramById(dtoInData) {
    let commandUri = Calls.getCommandUri("program/get");
    return Calls.call("get", commandUri, dtoInData);
  },
  async getSubjectById(dtoInData  ) {
    let commandUri = Calls.getCommandUri("subject/get");
    if(dtoInData) {
    return Calls.call("get", commandUri, dtoInData);}
  },
  async editSubject(dtoInData) {
    let commandUri = Calls.getCommandUri("subject/edit");
    return Calls.call("post", commandUri, dtoInData);
  },
  async createSubject(dtoInData) {
    let commandUri = Calls.getCommandUri("subject/create");
    return Calls.call("post", commandUri, dtoInData);
  },
  async addSubjectToProgram(dtoInData) {
    let commandUri = Calls.getCommandUri("program/add/subject");
    return Calls.call("post", commandUri, dtoInData);
  },
  async createTopicOfSubject(dtoInData) {
    let commandUri = Calls.getCommandUri("topic/create");
    return Calls.call("post", commandUri, dtoInData);
  },
  async authorization(dtoInData) {
    let commandUri = Calls.getCommandUri("authorization");
    return Calls.call("get", commandUri, dtoInData);
  },
  async addMaterialOfTopic(dtoInData) {
    let commandUri = Calls.getCommandUri("material/create");
    return Calls.call("post", commandUri, dtoInData);
  },
  async removeMaterialOfTopic(dtoInData) {
    let commandUri = Calls.getCommandUri("material/remove");
    return Calls.call("post", commandUri, dtoInData);
  },
