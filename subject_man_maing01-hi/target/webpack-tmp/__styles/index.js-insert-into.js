function insert(styleEl) {
  ...
  styleEl.setAttribute("data-owner", "subject_man_maing01-hi/subject_man_maing01-hi@0.1.0-DEV");
  styleEl.setAttribute("data-emotion", "subjectman");
  styleEl.setAttribute("data-tech", "less");

  // insert the style element
  // 1. after last matching data-emotion using technology "less"
  let els = insertionEl.querySelectorAll(`style[data-emotion="subjectman"]`);
